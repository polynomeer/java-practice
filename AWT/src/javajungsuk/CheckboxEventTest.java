...
class CheckboxEventTest extends Frame {
    ...
    CheckboxEventTest(String title) {
        ...
        q1 = new Label("1. ActionEvent actionPerformed 다음 중 의 메서드가"
                + " 호출되는 경우는 ? (모두 고르세요 .)");
        q1cb1 = new Checkbox("Button을 눌렀을 때 ");
                q1cb2 = new Checkbox("TextField Enter  에서 키를 눌렀을 때");
        q1cb3 = new Checkbox("MenuItem 을 클릭했을 때");
                q1cb4 = new Checkbox("List item 에서 더블클릭으로 을 선택했을 때");
                q2 = new Label("2. Frame LayoutManager ? ( 의 기본 는 하나만 고르세요.)");
        ...
        score = new Label("* 결과:");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                score.setText("* 결과: 당신의 점수는" + totalScore
                        + " 점 입니다.");
            }
        });
        add(q1);
    ...
    public static void main(String args[]) {
        CheckboxEventTest mainWin =
                new CheckboxEventTest("javajungsuk.CheckboxEventTest - Quiz");
    } // main메서드의 끝
}